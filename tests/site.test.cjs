...
assert(/\.figure-links a[\s\S]*min-height:\s*44px/.test(styles),'Figure links need 44px tap targets');
assert(/\.source-link[\s\S]*min-height:\s*44px/.test(styles),'Source links need 44px tap targets');
assert(/\.entry-link[\s\S]*min-height:\s*44px/.test(styles),'Entry links need 44px tap targets');
assert(/\.footer-link[\s\S]*min-height:\s*44px/.test(styles),'The footer crisis link needs a 44px tap target');
