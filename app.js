...
function overview(){return head('01','Why is the fence still there?','In April 2018, the City Council chose to pursue a permanent barrier. The temporary fence installed in September 2018 remains on the bridge.')+`
  <article class="feature-card lead overview-summary"><p class="eyebrow">THE SHORT VERSION</p><p class="large">As of September 2026, the records reviewed for this guide do not show an approved permanent design.</p><p>The temporary fence stayed while the City tested full-size examples, gathered public feedback, held commission reviews, changed consultants, and studied the options further. Construction also required funding separate from the design budget.</p>
