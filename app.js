...
const reviewDates = Object.freeze({baseline:'2026-09-01',siteUpdated:'2026-09-13',projectPage:'2026-09-13',heightFAQ:'2026-09-13',scannedReports:'2026-09-13',financeRow:'2026-09-13'});
...
if(returnTools) {
  returnTools.addEventListener('click',()=>{
    if(!menuOpen) {menuOpen=true;document.documentElement.classList.add('menu-open');menuToggle?.setAttribute('aria-expanded','true');}
